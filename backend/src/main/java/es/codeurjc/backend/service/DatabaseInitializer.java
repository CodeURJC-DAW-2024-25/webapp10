...
public class DatabaseInitializer {
	...
	public void init() throws IOException, URISyntaxException {
		...
		Concert oneDirectionConcert = new Concert("One Direction Reunion Tour", "The biggest concert of One Direction, reuniting all original members for an unforgettable night. Fans will enjoy a nostalgic trip with their favorite hits and new surprises.", "2025-08-16", "19:00:00", "Seville", 150, 75, List.of(HarryStyles, ZaynMalik, NiallHoran, LiamPayne, LouisTomlinson), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
		Concert shawnConcert = new Concert("Wonder Tour", "The biggest concert of Shawn Mendes, performing songs from his latest album and fan favorites. Expect a night full of energy, emotion, and incredible music.", "2025-12-25", "20:30:00", "Valencia", 110, 55, List.of(ShawnMendes), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
		Concert dukiConcert = new Concert("The Ameri Concert", "The biggest concert of Duki, bringing the best of Trap music. This event promises to be a high-energy show with electrifying performances.", "2025-03-21", "22:00:00", "Bilbao", 130, 65, List.of(Duki), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
		Concert taylorKanyeConcert = new Concert("The Galactic Duo", "A special concert featuring Taylor Swift and Kanye West, a unique collaboration of Pop and Hip-Hop. This once-in-a-lifetime event will showcase their greatest hits and new collaborations.", "2025-12-15", "21:00:00", "Barcelona", 200, 100, List.of(TaylorSwift, KanyeWest), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
		...
		Concert saikoConcert = new Concert("Saiko Tour", "The biggest concert of Saiko, performing his latest hits and fan favorites. This event promises to be a night full of energy and unforgettable performances.", "2025-10-05", "21:00:00", "Barcelona", 110, 55, List.of(Saiko), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
		Concert bunnyConcert = new Concert("Bad Bunny World Tour", "The biggest concert of Bad Bunny, featuring his greatest hits and new releases. This concert will take you on a journey through his musical career, with stunning visuals and unforgettable performances.", "2025-11-20", "20:00:00", "Seville", 160, 80, List.of(BadBunny), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
		Concert gyalConcert = new Concert("Bad Gyal Tour", "The biggest concert of Bad Gyal, performing her latest hits and fan favorites. This event promises to be a night full of energy and unforgettable performances.", "2025-12-05", "21:00:00", "Valencia", 120, 60, List.of(BadGyal), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
		Concert emiliaConcert = new Concert("Emilia Mernes Live", "The biggest concert of Emilia Mernes, performing her latest hits and fan favorites. This event promises to be a night full of energy and unforgettable performances.", "2025-12-20", "21:00:00", "Bilbao", 130, 65, List.of(EmiliaMernes), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
		...
		Concert aitanaConcert = new Concert("Aitana Tour", "The biggest concert of Aitana, performing her latest hits and fan favorites. This event promises to be a night full of energy and unforgettable performances.", "2025-08-20", "20:00:00", "Barcelona", 140, 70, List.of(Aitana), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
		Concert latinFestival = new Concert("Latin Festival", "The biggest Latin music festival, featuring the best Latin artists in the world. This event promises to be a night full of energy, unforgettable performances, and a celebration of Latin culture.", "2025-09-30", "18:00:00", "Barcelona", 250, 125, List.of(Duki, RauwAlejandro, Saiko, BadBunny, BadGyal, EmiliaMernes, Quevedo, KarolG), "https://maps.app.goo.gl/YMYM7WxM2PubhQTSA");
